...
public class ProductDao {
    ...
    public List<Product> getListProduct() {
        ...
        products.add(new Product(
                2, catNoiThat, 1, false, "Gỗ tự nhiên", 0, "Bàn fullsize 1m2",
        ...
        products.add(new Product(
                4, catNoiThat, 1, false, "Thép", 0, "Khác",
        ...
        products.add(new Product(
                6, catTrangTri, 2, false, "In UV trực tiếp lên Mica tráng gương", 0, "35x70cm (2 tấm) + 70x70cm (1 tấm)",
        ...
        products.add(new Product(
                8, catDoChoi, 3, false, "Nhựa Cao Cấp", 0, "239 × 210 × 230 cm",
                "Nhà chơi trẻ em", "ODM",
        ...
        products.add(new Product(
                10, catNoiThat, 1, false, "Gỗ tự nhiên", 0, "Bàn fullsize 1m2",
                "Mô tả sản phẩm...", "Fancy TopKids",
